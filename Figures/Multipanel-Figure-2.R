...
dataImp <- read_csv('F1Results/imputation_ff_4.csv')

for(i in seq(5,50)){
  print(i)
  temp <- read_csv(paste('F1Results/imputation_ff_',i,'.csv',sep=''))
...
#read in random data
dataRan <- read_csv('F1Results/random_ff_1.csv')
for(i in seq(2:50)){
  temp <- read_csv(paste('F1Results/random_ff_',i,'.csv',sep=''))
...
dataRes <- read_csv('F1Results/resampled_ff_1.csv')
for(i in seq(2:50)){
  temp <- read_csv(paste('F1Results/resampled_ff_',i,'.csv',sep=''))
...
for(i in seq(5,50)){
  print(i)
  temp <- read_csv(paste('Results/imputation_ff_',i,'.csv',sep=''))
  dataImp <- bind_rows(dataImp,temp)
}
...
ggsave(plot = multipanel,'Figures/MultiPanel-Figure-2.png', device='png',width = 7.5, height = 10, units = c("in"),dpi=300)
ggsave(plot = multipanel,'Figures/MultiPanel-Figure-2.tiff', device='tiff',width = 7.5, height = 10, units = c("in"),dpi=300)

...
test <- ggarrange(ranP,resP, impP, f1ranP,f1resP,f1impP,NULL,leg, labels = c('A','B','C','D','E','F','',''), ncol = 3, nrow=3)
test

test <- ggarrange(ranP,resP, impP,NULL,leg, f1ranP,f1resP,f1impP, labels = c('A','B','C','','','D','E','F'), ncol = 5, nrow=2,widths = c(2,2,2,1,1))
test

ggsave(plot = test,'MultiPanel-Figure-3.png', device='png',width = 10, height = 3.75, units = c("in"),dpi=300)

p6

p6 <- ggarrange(p5,f1impP,labels = c('','C'), nrow=2, font.label = list(size = 10))
p6

ggsave(plot = p6,'Figures/F1-Figure-3.png', device='png',width = 5, height = 3.75, units = c("in"),dpi=300)
ggsave(plot = p6,'Figures/F1-Figure-3.tiff', device='tiff',width = 5, height = 3.75, units = c("in"),dpi=300)

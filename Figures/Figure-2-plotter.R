...
ggsave(plot = p6,'Figures/Figure-2.png',width = 10, height = 7.5, units = c("in"), dpi = 300)
ggsave(plot = p6,'Figures/Figure-2.tiff',device='tiff', width = 10, height = 7.5, units = c("in"),dpi = 300)

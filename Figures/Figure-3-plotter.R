...
ggsave(plot = p6,'Figures/Figure-3.png', device='png',width = 10, height = 7.5, units = c("in"),dpi=300)
ggsave(plot = p6,'Figures/Figure-3.tiff', device='tiff',width = 10, height = 7.5, units = c("in"),dpi=300)

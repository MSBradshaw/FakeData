...
ggsave(plot = p,'Figures/Supplemental-Figure-3.png', device='png',width = 8, height = 11, units = c("in"),dpi=300)
ggsave(plot = p,'Figures/Supplemental-Figure-3.tiff', device='tiff',width = 8, height = 11, units = c("in"),dpi=300)
